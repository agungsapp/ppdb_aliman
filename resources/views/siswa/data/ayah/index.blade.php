				...
				<div class="container">
						<div class="row align-items-end justify-content-center text-center">
								<div class="col-lg-7">
										...
										<p>silahkan lengkapi data ayah kandung anda.</p>
								</div>
						</div>
				</div>
		</div>
		...
		<div class="site-section">
				<div class="container">
						...
						<div class="row justify-content-center">
								<div class="col-md-12">
										<form action="{{ route('siswa.data-ayah.store') }}" method="POST">
												@csrf
												<div class="row mb-5">
														{{-- nik --}}
														<div class="col-md-6 form-group">
																<label for="nik" class="text-capitalize">nik</label>
																<input type="number" id="nik" name="nik" placeholder="masukan nik ayah ..."
														...
														<div class="col-md-6 form-group">
																...
																<input type="text" id="nama" name="nama" placeholder="masukan nama ayah ..."
														...
														<div class="col-md-6 form-group">
																...
																<input type="text" id="tempat_lahir" name="tempat_lahir" placeholder="masukan tempat_lahir ayah ..."
														...
														<div class="col-md-6 form-group">
																...
																<input type="date" id="tanggal_lahir" name="tanggal_lahir" placeholder="masukan tanggal_lahir ayah ..."
														...
														<div class="col-md-6 form-group">
																...
																<input type="number" id="nomor_telepon" name="nomor_telepon" placeholder="masukan nomor_telepon ayah ..."
														...
														<div class="col-md-6 form-group">
																...
																<textarea id="alamat" name="alamat" placeholder="masukan alamat ayah ..."
