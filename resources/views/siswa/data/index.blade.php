				...
				<div class="container">
						<div class="row align-items-end justify-content-center text-center">
								<div class="col-lg-7">
										...
										<p>Silahkan lengkapi data data di bawah ini untuk melanjutkan pendaftaran peserta didik baru.</p>
								</div>
						</div>
				</div>
		</div>
				...
				<div class="container">
						...
						<div class="row justify-content-center mb-0 text-center">
								<div class="col-lg-12 mb-2">
										<h2 class="">
												<span>Halo, Selamat datang <strong>{{ Auth::user()->nama }}</strong> </span>
												<p>silahkan lanjutkan isi data.</p>
										</h2>
								</div>
						</div>
						<div class="row justify-content-center">
								<div class="col-md-12">
										<form action="{{ route('siswa.data.store') }}" method="POST">
												@csrf
												<div class="row mb-5">
														{{-- nik --}}
														<div class="col-md-6 form-group">
																<label for="nik" class="text-capitalize">nik</label>
																<input type="number" id="nik" name="nik" placeholder="masukan nik anda ..."
														...
														<div class="col-md-6 form-group">
																...
																<input type="number" id="nisn" name="nisn" placeholder="masukan nisn anda ..."
																		value="{{ old('nisn') }}" class="form-control @error('nisn') is-invalid @enderror form-control-lg">
																@error('nisn')
																		<div class="invalid-feedback">{{ $message }}</div>
																@enderror
														</div>
														{{-- jenis kelamin --}}
														<div class="col-md-6 form-group">
																<label for="jk" class="text-capitalize">Jenis Kelamin</label>
																<select id="jk" class="form-control @error('jk') is-invalid @enderror form-control-lg form-select"
																		name="jk">
														...
														<div class="col-md-6 form-group">
																...
																<input type="text" id="tempat_lahir" name="tempat_lahir" placeholder="masukan tempat_lahir anda ..."
														...
														<div class="col-md-6 form-group">
																...
																<input type="date" id="tanggal_lahir" name="tanggal_lahir" placeholder="masukan tanggal_lahir anda ..."
														...
														<div class="col-md-6 form-group">
																...
																<textarea id="alamat" name="alamat" placeholder="masukan alamat anda ..."
														...
														{{-- sekolah asal --}}
														<div class="col-md-6 form-group">
																<label for="sekolah_asal" class="text-capitalize">sekolah asal</label>
																<input type="text" id="sekolah_asal" name="sekolah_asal" placeholder="masukan sekolah_asal anda ..."
																		value="{{ old('sekolah_asal') }}"
																		class="form-control @error('sekolah_asal') is-invalid @enderror form-control-lg">
																@error('sekolah_asal')
																		<div class="invalid-feedback">{{ $message }}</div>
																@enderror
														</div>
														{{-- tahun lulus --}}
														<div class="col-md-6 form-group">
																<label for="tahun_lulus" class="text-capitalize">tahun lulus</label>
																<input type="number" id="tahun_lulus" name="tahun_lulus" placeholder="masukan tahun_lulus anda ..."
																		value="{{ old('tahun_lulus') }}"
																		class="form-control @error('tahun_lulus') is-invalid @enderror form-control-lg">
																@error('tahun_lulus')
																		<div class="invalid-feedback">{{ $message }}</div>
																@enderror
														</div>
														...
														<div class="col-md-6 form-group">
																...
																<input type="number" id="nomor_telepon" name="nomor_telepon"
																		placeholder="masukan nomor_telepon anda ..." value="{{ old('nomor_telepon') }}"
